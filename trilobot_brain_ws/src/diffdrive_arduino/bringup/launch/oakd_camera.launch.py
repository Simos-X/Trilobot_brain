...
def generate_launch_description():
    depthai_examples_path = get_package_share_directory('diffdrive_arduino')
    ...
    camera_model = LaunchConfiguration('camera_model',  default = 'OAK-D-S2')
    ...
    confidence            = LaunchConfiguration('confidence', default = 50)
    ...
    stereo_node = launch_ros.actions.Node(
            package='depthai_stereo_intertial', executable='stereo_inertial_node', #depthai_stereo_intertial
            output='screen',
    ...
    # ld.add_action(color_img_compress)
    # ld.add_action(left_img_compress)
    # ld.add_action(right_img_compress)
    return ld
